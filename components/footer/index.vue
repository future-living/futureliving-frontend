<template>
    <div class="max-w-[1440px] py-10  mx-auto px-[20px] sm:px-[36px] md:px-[72px] lg:px-8 bg-[#4D265A]">
        <div class="h-full flex flex-col gap-8 lg:flex-row lg:justify-between mb-8">
            <div class="flex flex-col max-w-[320px]">
                ...
                <div class="font-montserrat font-normal text-sm leading-[26px] text-slate-200 mb-4">Kami menyediakan
                    informasi mengenai properti untuk membantu Anda menemukan hunian impian</div>
                <div class="flex flex-row gap-6">
                    <a href="https://facebook.com"><img src="~/assets/img/facebook.svg" alt="facebook"></a>
                    <a href="https://twitter.com"><img src="~/assets/img/twitter.svg" alt="twitter"></a>
                    <a href="https://instagram.com"><img src="~/assets/img/instagram.svg" alt="instagram"></a>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-4 lg:gap-[60px] ">
                <div class="flex flex-col">
                    <div class="font-montserrat font-bold text-base text-slate-200 mb-[18px]">Artikel</div>
                    <div class="font-montserrat font-normal text-sm leading-[26px] text-slate-200 mb-2">About Us</div>
                    <div class="font-montserrat font-normal text-sm leading-[26px] text-slate-200 mb-2">About Us</div>
                    <div class="font-montserrat font-normal text-sm leading-[26px] text-slate-200 mb-2">About Us</div>
                    <div class="font-montserrat font-normal text-sm leading-[26px] text-slate-200 mb-2">About Us</div>
                </div>
            ...
            <div class="flex flex-col max-w-[320px] gap-6">
                <div>
                    <div class="font-montserrat font-bold text-base text-slate-200">Artikel</div>
                    <div class="font-montserrat font-normal text-sm leading-[26px] text-slate-200">Kami menyediakan
                        informasi mengenai properti untuk membantu Anda menemukan hunian impian</div>
                </div>
                <div>
                    <div class="font-montserrat font-bold text-base text-slate-200">Contact</div>
                    <div class="font-montserrat font-normal text-sm leading-[26px] text-slate-200">+62 827-0986-4567
                    </div>
                </div>
            </div>
        </div>
        <div
            class="h-full py-2 flex flex-col border-t-[0.5px] border-white justify-center lg:gap-8 lg:flex-row lg:justify-between">
            <div class="font-montserrat font-normal text-sm text-slate-200 text-center lg:text-left lg:mb-4">Privacy And
                Policy - Terms
                And Agreement</div>
            <div class="font-montserrat font-normal text-sm text-slate-200  text-center lg:w-[320px] lg:text-left lg:mb-4 ">
                @2023 Future
                Living. All
                Right Reserved</div>
        </div>
